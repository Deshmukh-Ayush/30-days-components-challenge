...
export default function ToolbarExpandable() {
    ...
    return (
        <div className='absolute bottom-64 left-1/2 -translate-x-1/2' ref={ref}>
            <div
                    ...
                    {ITEMS.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    'relative flex h-9 shrink-0 select-none appearance-none items-center justify-center gap-1.5 rounded-lg px-2 text-zinc-500 transition-colors hover:bg-zinc-100 hover:text-zinc-800 focus-visible:ring-2 active:scale-[0.98]',
